...
from app.models.job import (
    ...
    JobSearchRequest, JobListResponse, CompanyListResponse,
    JobApplicationListResponse, ApplicationStatus
)
...
class JobService:
    ...
    async def create_company(self, company_data: CompanyCreate, user_id: int) -> Company:
    ...
    async def get_companies(self, page: int = 1, per_page: int = 20) -> CompanyListResponse:
    ...
    async def get_jobs(self, search_request: JobSearchRequest) -> JobListResponse:
        ...
        try:
            ...
            if search_request.query:
                where_conditions.append("(j.title ILIKE :query OR j.description ILIKE :query)")
    ...
    async def apply_to_job(self, application_data: JobApplicationCreate, user_id: int) -> JobApplication:
        """Apply to a job"""
        try:
